...
class CalcMesh:
    ...
    def __init__(self, nodes_coords, tetrs_points):
        ...
        self.smth = np.multiply(np.sin(self.nodes[0, :]), np.power(self.nodes[0, :], -1))
    ...
    def move(self, tau):
        ...
        self.smth  = np.sin(self.smth * tau * 1500)
    ...
    def snapshot(self, snap_number):
        ...
        writer.SetFileName("pawn/tetr3d-step-" + str(snap_number) + ".vtu")
        writer.Write()
...
try:
    ...
    gmsh.merge(os.path.join(path, 'Pawn.stl'))
except:
